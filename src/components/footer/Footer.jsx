...
const Footer = () => {
    ...
    <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
      <div className="lg:w-1/6 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Hats</a>
          </li>
      ...
      <div className="lg:w-1/6 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Men fasihon</a>
          </li>
      ...
      <div className="lg:w-1/6 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Women clothes</a>
          </li>
      ...
      <div className="lg:w-1/6 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">kid Garments</a>
          </li>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© <span>{new Date().getFullYear()} <b>Zain</b> </span>
        <a href="#" className="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">@ZainQamer</a>
      </p>
